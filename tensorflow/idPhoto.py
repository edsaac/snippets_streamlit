...
path_to_model = "/home/edsaa/Repositories/dashboards/BasicStreamlit/tensorflow/cnn_model.h5"
...
if uploaded_file is not None:
    ...
    with Image.open(uploaded_file) as photo:
        tensorflow_image = preprocess_image(photo)
...
if st.sidebar.button("Click Here to Predict"):
    ...
    if uploaded_file is None: st.sidebar.write("Please upload an Image to Classify")
    else:      
